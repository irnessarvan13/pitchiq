...
# GET /matches — fetches ALL matches from the database and returns them as a list
...
# GET /matches/{match_id} — fetches ONE specific match by id
...
# POST /matches — creates a NEW match in the database
